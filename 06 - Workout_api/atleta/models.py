...
class AtletaModel(BaseModel):
    ...
    categoria: Mapped["CategoriaModel"] = relationship(back_populates="atleta", lazy="joined")

    centro_treinamento_id: Mapped[int] = mapped_column(ForeignKey("centros_treinamento.pk_id"), nullable=False)
    centro_treinamento: Mapped["CentroTreinamentoModel"] = relationship(back_populates="atleta", lazy="joined")
